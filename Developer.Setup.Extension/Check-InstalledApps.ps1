...
# Usage:
#
#   Check-InstalledApps -match "micro" -first $false
#
# Author:
...
param(
    ...
    $arrMatch = Check-InstalledApps -match $match -ignore $ignore #-firstOnly $true
...
Stop-OnAppIsInstalled -pkgName 'test' -match 'Visual Studio 2012 Update 2 .*'